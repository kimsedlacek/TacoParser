...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ITrackable trackableTB1 = null;
            ITrackable trackableTB2 = null;
            ...
            for(int i  = 0; i < locations.Length; i++)
            {
                ...
                for(int j = 0; j < locations.Length; j++)
                {
                    ...
                    var locationDistance = corA.GetDistanceTo(corB);
            ...
            Console.WriteLine($"Taco Bells furthest apart: {trackableTB1.Name} and {trackableTB2.Name}");
